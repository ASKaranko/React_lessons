...
class App extends Component {
  ...
  // state можно указать в this.state в конструкторе
  // но React делает это за нас за сценой
  // это более современный синтаксис
  state = {
    persons: [
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    // Должен возвращать обновленное состояние, исходя из props
    return state;
  }

  // Необходим, если нужно обновить состояние перед render
  // Удален, так как дублирует getDerivedStateFromProps
  // componentWillMount() {
